...
One of the best reasons to use computers for research is that they don't get bored. For our assignment we will need to repeat many actions on different datasets, often without knowing how many datasets we will end up with. We can automate actions and repeat them, using a process called a loop.
