...
intersect = circle.intersection(combined)
...
for i in range(1, 3):
    ...
    if i == 1:
        plt.fill(*poly_r.exterior.xy, c='tab:blue', alpha=0.7)
        plt.fill(*poly_l.exterior.xy, c='r', alpha=0.7)
        plt.fill(*circle.exterior.xy, c='k', alpha=0.7)

    if i == 2:
        plt.fill(*intersect.exterior.xy, c='tab:blue', alpha=0.7)
